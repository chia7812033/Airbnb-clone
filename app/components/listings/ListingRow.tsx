...
const ListingRow: React.FC<ListingRowProps> = ({
  ...
  return (
    <div className='cursor-pointer hover:shadow-lg transition p-2 pl-4 pt-4 bg-white'>
      <div>
        {order && (
          <div
          ...
          >
            <CustomAvatar currentUser={reservation.user} />
          ...
          <div className='flex justify-between w-full items-center pr-4'>
            <div className='px-2 flex flex-col justify-around h-full'>
              ...
              <div className='text-gray-600'>
                {`${reservationDate} (${reservationDays} Night)` ||
                  data.category}
              </div>
        ...
        {order && (
          <div className='w-full flex flex-row justify-end border-t-[0.5px] py-2'>
            Order number: #{reservation.id}
          </div>
        )}
      </div>
    </div>
